...
__all__ = ['load_audio', 'AudioMono', 'duration', 'SpecImage', 'MaskBinary', 'show_batch', 'show', 'show', 'show',
           'ArrayAudioBase', 'ArraySpecBase', 'ArrayMaskBase', 'TensorAudio', 'TensorSpec', 'TensorMask', 'encodes',
           'encodes', 'encodes', 'audio2tensor', 'spec2tensor', 'mask2tensor', 'Spectify', 'Decibelify',
